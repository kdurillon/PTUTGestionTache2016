...
Router.onBeforeAction(function() {
    ...
    if (!Meteor.userId()) { // Si l'utilisateur n'est pas connecté, on lui affiche le formulaire de login
        ...
        "home", "pageNotFound", "login", "register", "formulaireGenere", "forgotpassword", "resetpassword"
    ]
});
...
Router.route('/SuppressionFormulaire', {
    name: 'formulaireSupprime',
    template: "formulaireSupprime"
});
